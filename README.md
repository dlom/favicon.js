...
A tiny (726 bytes) library for changing the favicon of the page.

[Live demo](http://dlom.github.com/favicon.js/)

## Download

[favicon.min.js](http://dlom.github.com/favicon.js/favicon.min.js)
...
### Examples
```javascript
favicon.change("http://g.etfv.co/http://en.wikipedia.org", "Wikipedia, the free encyclopedia");
favicon.animate([
...
It should work on most modern browsers (such as Firefox) but hasn't been tested yet

## Credits

Based heavily on [the original favicon.js](http://softwareas.com/dynamic-favicons)
